                            ...
                            <div className="col-md-8 col-lg-9">
                                <div className="p-t-80 p-b-124 bo5-r h-full p-r-50 p-r-0-md bo-none-md">
                                    ...
                                    <div className="blo4 p-b-63">
                                        ...
                                        <div className="text-blo4 p-t-33">
                                            <h4 className="p-b-16">
                                                <a href="blog-detail.html" className="tit9">Pizza is prepared fresh</a>
                                            </h4>
                                            <div className="txt32 flex-w p-b-24">
                                                <span>
                                                    by Admin
                                    ...
                                    <div className="blo4 p-b-63">
                                        ...
                                        <div className="text-blo4 p-t-33">
                                            <h4 className="p-b-16">
                                                <a href="blog-detail.html" className="tit9">Style the Wedding Party</a>
                                            </h4>
                                            <div className="txt32 flex-w p-b-24">
                                                <span>
                                                    by Admin
                                    ...
                                    <div className="blo4 p-b-63">
                                        ...
                                        <div className="text-blo4 p-t-33">
                                            <h4 className="p-b-16">
                                                <a href="blog-detail.html" className="tit9">Best Places for Wine</a>
                                            </h4>
                                            <div className="txt32 flex-w p-b-24">
                                                <span>
                                                    by Admin
                            ...
                            <div className="col-md-4 col-lg-3">
                                <div className="sidebar2 p-t-80 p-b-80 p-l-20 p-l-0-md p-t-0-md">
                                    ...
                                    <div className="popular">
                                        <h4 className="txt33 p-b-35 p-t-58">
                                            Most popular
                                        </h4>
                                        <ul>
